...
for url in foodnet_urls_List:
    ...
    with open ("recipe_list.csv", "a") as csv_file:
        csv_writer = writer(csv_file, quoting=csv.QUOTE_ALL)
        rows=[recipe_name, servings,total_time, instructions]
...
for url in foodnet_urls_List:
    ...
    with open ("ingredients_list.csv","a") as csv_file:
        csv_writer = writer(csv_file, quoting=csv.QUOTE_ALL)
        for items in ingredients:    
            rows= [recipe_name,items]
            csv_writer.writerow(rows)
